...
namespace DTPortal.Core.DTOs
{
    ...
    public class ClientDTO
    {
        ...
        [Required]
        [RegularExpression(@"^https:\/\/[A-Za-z0-9.-]+(:[0-9]+)?(\/.*)?$", ErrorMessage = "Invalid ApplicationUrl.")]
        public string ApplicationUrl { get; set; }

        [Required]
        [RegularExpression(@"^https:\/\/[A-Za-z0-9.-]+(:[0-9]+)?(\/.*)?$", ErrorMessage = "Invalid RedirectUri.")]
        ...
        [RegularExpression(@"^https:\/\/[A-Za-z0-9.-]+(:[0-9]+)?(\/.*)?$", ErrorMessage = "Invalid LogoutUri.")]
