...
namespace DTPortal.Core.Domain.Services.Communication
{
    ...
    public class VerifyUserAuthDataRequest
    {
        ...
        [StringLength(50)]
        [RegularExpression(@"^[A-Za-z0-9+/=]*$", ErrorMessage = "AuthenticationData must be a valid Base64-like string.")]
    ...
    {
        [StringLength(100)]
        [RegularExpression(@"^(?!\s*$)[A-Za-z0-9\-\._~]+$", ErrorMessage = "Invalid authorization code format.")]
        ...
        [RegularExpression(@"^(?!\s*$)[A-Za-z][A-Za-z0-9+\-.]*:\/\/[^\s]+$",
        ...
        [RegularExpression(@"^(?!\s*$)[A-Za-z0-9\-\._~\+\/=]*$", ErrorMessage = "Invalid client_secret format.")]
        public string client_secret { get; set; }

        [StringLength(500, MinimumLength = 1)]
        [RegularExpression(@"^(?=.*[A-Za-z0-9])[A-Za-z0-9 ._:\-/]+$",
            ErrorMessage = "Invalid scope format.")]
        public string scope { get; set; }

        [StringLength(200, MinimumLength = 1)]
        [RegularExpression(@"^(?!\s*$)[A-Za-z0-9\-\._~]+$", ErrorMessage = "Invalid PKCE code_verifier.")]
        public string code_verifier { get; set; }

        [StringLength(100, MinimumLength = 1)]
        [RegularExpression(@"^urn:ietf:params:oauth:client-assertion-type:jwt-bearer$",
            ErrorMessage = "Invalid client_assertion_type.")]
        public string client_assertion_type { get; set; }

        [StringLength(5000, MinimumLength = 1)]
        [RegularExpression(@"^(?!\s*$)[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+$",
            ErrorMessage = "Invalid JWT client_assertion.")]
        public string client_assertion { get; set; }

        [StringLength(2000, MinimumLength = 1)]
        [RegularExpression(@"^(?!\s*$)[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+$",
            ErrorMessage = "Invalid JWT assertion.")]
        public string assertion { get; set; }

        [StringLength(2000,MinimumLength =1)]
        [RegularExpression(@"^(?!\s*$)[A-Za-z0-9\-\._~\+\/=]+$", ErrorMessage = "Invalid refresh token format.")]
